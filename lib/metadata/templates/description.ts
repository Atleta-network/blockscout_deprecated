...
const DEFAULT_TEMPLATE = 'Atlascan is the #1 open-source blockchain explorer available today. 100+ chains and counting rely on Atlascan data availability, APIs, and ecosystem tools to support their networks.';
